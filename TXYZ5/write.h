...
void WriteResults(double tau, GRID HydroGrid)
{
	...
	{	
		...
		{ 
			...
			buf[k*PRINTVAR+1]=HydroGrid[i][j][k].Temp;
			buf[k*PRINTVAR+2]=HydroGrid[i][j][k].P;	
			buf[k*PRINTVAR+3]=HydroGrid[i][j][k].Vx;
			buf[k*PRINTVAR+4]=HydroGrid[i][j][k].Vy;
			buf[k*PRINTVAR+5]=HydroGrid[i][j][k].Ve; 
					
			buf[k*PRINTVAR+6]=HydroGrid[i][j][k].pi[0];
			buf[k*PRINTVAR+7]=HydroGrid[i][j][k].pi[1];
			buf[k*PRINTVAR+8]=HydroGrid[i][j][k].pi[2];
			buf[k*PRINTVAR+9]=HydroGrid[i][j][k].pi[3];
			buf[k*PRINTVAR+10]=HydroGrid[i][j][k].pi[4];
			buf[k*PRINTVAR+11]=HydroGrid[i][j][k].PI;
